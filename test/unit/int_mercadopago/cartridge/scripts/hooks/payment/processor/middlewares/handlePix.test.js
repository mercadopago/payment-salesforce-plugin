...
const hookPath =
  "*/../../cartridges/int_mercadopago/cartridge/scripts/hooks/payment/processor/middlewares/handlePix.js";
...
describe("Hook MERCADOPAGO_PAYMENTS middleware handlePix test", () => {
  const handlePix = proxyquire(hookPath, proxyquireObject);
  ...
  it("should return an object without error", () => {
    ...
    const result = handlePix(basket, paymentInformation);
