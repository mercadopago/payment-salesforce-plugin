...
const hookPath =
  "*/../../cartridges/int_mercadopago/cartridge/scripts/hooks/payment/processor/middlewares/authorizeMethodsOff.js";
...
describe("Hook MERCADOPAGO_PAYMENTS middleware authorizeMethodsOff test", () => {
  const authorizeMethodsOff = proxyquire(hookPath, proxyquireObject);
  ...
  it("should return an object without error", () => {
    ...
    const result = authorizeMethodsOff(
      orderNumber,
      paymentInstrument,
      PAYMENT_PROCESSOR
    );
