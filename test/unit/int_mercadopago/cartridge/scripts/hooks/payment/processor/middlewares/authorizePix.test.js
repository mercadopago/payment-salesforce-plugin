...
const hookPath =
  "*/../../cartridges/int_mercadopago/cartridge/scripts/hooks/payment/processor/middlewares/authorizePix.js";
...
describe("Hook MERCADOPAGO_PAYMENTS middleware authorizePix test", () => {
  const authorizePix = proxyquire(hookPath, proxyquireObject);
