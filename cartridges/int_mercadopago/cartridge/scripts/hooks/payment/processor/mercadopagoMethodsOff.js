...
function Handle(basket, paymentInformation) {
  return middlewares.handleMethodsOff(basket, paymentInformation);
}
...
function Authorize(order, paymentInstrument, paymentProcessor) {
  return middlewares.authorizeMethodsOff(order, paymentInstrument, paymentProcessor);
}
...
function processForm(req, paymentForm, viewFormData) {
  return middlewares.processFormMethodsOff(req, paymentForm, viewFormData);
}
